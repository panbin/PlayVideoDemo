...
- (void)layoutSubviews
{
    ...
    CGSize titleLabelSize = [[_titleLabel text] sizeWithMyFont:[_titleLabel font]];
    CGSize descriptionLabelSize = [[_descriptionLabel text] sizeWithMyFont:[_descriptionLabel font]];
